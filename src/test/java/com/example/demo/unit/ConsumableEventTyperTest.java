...
import com.example.demo.endpoint.event.consumer.model.ConsumableEvent;
import com.example.demo.endpoint.event.consumer.model.ConsumableEventTyper;
import com.example.demo.endpoint.event.consumer.model.TypedEvent;
...
public class ConsumableEventTyperTest extends FacadeIT {
  ...
  void to_acknowledgeable_typed_event_ok() throws JsonProcessingException {
    ...
    var typedEvent = new TypedEvent("com.example.demo.endpoint.event.model.UuidCreated", payload);
  ...
  void to_acknowledgeable_typed_event_ko() throws JsonProcessingException {
    ...
    var validTypedEvent =
        new TypedEvent("com.example.demo.endpoint.event.model.UuidCreated", payload);
